    ...
    [
        ...
        <ol>
            <li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: <br> <br>
                <ul>
                    <li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera. <br> <br></li>
                    <li>Google LLC, con sede negli Stati Uniti, per il resto del mondo. <br> <br></li>
                </ul>
            </li>
            <li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali. <br> <br></li>
        </ol>
...
<body>
    ...
    <footer>
        <div class="footerContainer">
            <p>Google - Tutto su Google - Privacy - Privacy - Termini</p>
            <div>
                <select name="" id="">
